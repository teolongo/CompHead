...
- [x] 02-02-PLAN.md — Calls vertical slice: list_calls + search_transcript (Q3)
...
- [x] 04-01-PLAN.md — Graph API `/api/graph` from mock CRM/ERP data (UI-02, UI-03)
- [x] 04-02-PLAN.md — Artifact preflight: Q9 HTML deck + PDF + loop wiring (ART-01..03)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04-03-PLAN.md — Company Brain UI: chat, graph highlight, Three.js hero (UI-01..03)
